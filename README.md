# ClawdChat - P2P Terminal Session Sharing
...
```bash
# 克隆项目
git clone https://github.com/your-username/clawdchat.git
cd clawdchat
...
```bash
# 使用默认 shell
./target/release/clawdchat host

# 指定 shell 类型
./target/release/clawdchat host --shell zsh

# 自定义终端大小
./target/release/clawdchat host --width 120 --height 30
```
...
💡 Others can join using: clawdchat connect --ticket <ticket>
```
...
```bash
# 使用会话票据加入
./target/release/clawdchat connect MFRGG43FMVZXG5DFON2HE2LTMVZXG5DF...
```
...
# 查看可用的 shell
./target/release/clawdchat host --list-shells
```
...
- 项目主页：https://github.com/your-username/clawdchat
- 问题反馈：https://github.com/your-username/clawdchat/issues
- 讨论区：https://github.com/your-username/clawdchat/discussions
