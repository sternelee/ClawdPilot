  ...
  "relative w-full rounded-lg border p-4 shadow-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-destructive/50 text-destructive dark:border-destructive [&>svg]:text-destructive shadow-destructive/10",
        error:
          "border-error/50 text-error dark:border-error [&>svg]:text-error shadow-error/10",
        warning:
          "border-warning/50 text-warning dark:border-warning [&>svg]:text-warning shadow-warning/10",
        success:
          "border-success/50 text-success dark:border-success [&>svg]:text-success shadow-success/10",
        info:
          "border-info/50 text-info dark:border-info [&>svg]:text-info shadow-info/10"
      }
    },
    defaultVariants: {
      variant: "default"
