				...
				<div class="relative">
					...
					>
						<span class="text-[11px] font-medium text-base-content/50">
							{styleStore.manualOverride()
								? styleAppearanceLabel(styleStore.currentStyle())
								: "Auto"}
						</span>
					...
					<Show when={stylePickerOpen()}>
						<div class="absolute right-0 top-full mt-1 bg-base-100 border border-base-content/10 rounded-md shadow-lg z-50 min-w-[120px] overflow-hidden">
							<button
								...
								classList={{
									"text-primary font-medium": !styleStore.manualOverride(),
								}}
								onClick={() => {
									...
									<button
										...
										classList={{
											"text-primary font-medium":
												styleStore.manualOverride() &&
												styleStore.currentStyle() === s,
										}}
										onClick={() => {
											styleStore.setManualStyle(s);
											setStylePickerOpen(false);
										}}
									>
