...
const dictionaries = {
  en: flatten({
    ...
    setupGuide: {
      ...
      step1: {
        ...
        p2p: "P2P Direct",
        localCli: "Local CLI",
        footer: "After starting the service on your computer, achieve point-to-point secure access through a P2P tunnel.",
      },
      step2: {
        title: "Install CLI Tool",
        desc: "First, install the ClawdPilot CLI on your computer. Open a terminal and run:",
        windowsNote: "Windows users please refer to the GitHub documentation for installation",
      },
      step3: {
  ...
  "zh-CN": flatten({
    ...
    setupGuide: {
      ...
      step2: {
        title: "安装 CLI 工具",
        desc: "首先，在你的电脑上安装 ClawdPilot CLI。打开终端并运行：",
